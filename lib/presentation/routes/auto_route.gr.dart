...
/// generated route for
/// [_i1.ChatsScreen]
class ChatsScreenRoute extends _i21.PageRouteInfo<void> {
  const ChatsScreenRoute({List<_i21.PageRouteInfo>? children})
...
class FeedScreenRoute extends _i21.PageRouteInfo<void> {
  const FeedScreenRoute({List<_i21.PageRouteInfo>? children})
...
class FetchStoriesLoadingRoute
  ...
  FetchStoriesLoadingRoute({
    ...
    List<_i23.UserEntity>? storyUsers,
    List<_i21.PageRouteInfo>? children,
  }) : super(
...
class FetchStoriesLoadingRouteArgs {
  ...
  final List<_i23.UserEntity>? storyUsers;
...
class FetchStoriesLoadingSlidePageRoute
    extends _i21.PageRouteInfo<FetchStoriesLoadingSlidePageRouteArgs> {
  FetchStoriesLoadingSlidePageRoute({
    _i24.Key? key,
    required _i23.UserEntity user,
    required List<_i23.UserEntity> storyUsers,
    required String profilePicture,
    List<_i21.PageRouteInfo>? children,
  }) : super(
...
class SearchScreenRoute extends _i21.PageRouteInfo<void> {
  const SearchScreenRoute({List<_i21.PageRouteInfo>? children})
  ...
  static _i21.PageInfo page = _i21.PageInfo(
    name,
    builder: (data) {
      return const _i15.SearchScreen();
    },
  );
}
...
class StoryViewScreenRoute
  ...
  StoryViewScreenRoute({
    _i22.Key? key,
    required List<_i26.StoryEntitiy> stories,
    required String username,
    required String profilePicture,
...
class StoryViewScreenRouteArgs {
  ...
  final List<_i26.StoryEntitiy> stories;
...
/// generated route for
/// [_i19.StoryViewSlidePage]
class StoryViewSlidePageRoute
    extends _i21.PageRouteInfo<StoryViewSlidePageRouteArgs> {
  ...
  static _i21.PageInfo page = _i21.PageInfo(
    ...
    builder: (data) {
      ...
      return _i19.StoryViewSlidePage(
        key: args.key,
        stories: args.stories,
        username: args.username,
        profilePicture: args.profilePicture,
...
class UserProfileScreenRoute
  ...
  static _i21.PageInfo page = _i21.PageInfo(
    ...
    builder: (data) {
      ...
      return _i20.UserProfileScreen(key: args.key, username: args.username);
    },
  );
}
