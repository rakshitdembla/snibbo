...
class FetchStoriesLoadingRoute
  ...
  static _i19.PageInfo page = _i19.PageInfo(
    ...
    builder: (data) {
      ...
      return _i4.FetchStoriesLoading(
        key: args.key,
...
/// generated route for
/// [_i5.FetchStoriesLoadingSlidePage]
class FetchStoriesLoadingSlidePageRoute
  ...
  static _i19.PageInfo page = _i19.PageInfo(
    ...
    builder: (data) {
      ...
      return _i5.FetchStoriesLoadingSlidePage(
        key: args.key,
        user: args.user,
        storyUsers: args.storyUsers,
        profilePicture: args.profilePicture,
...
class StoryViewScreenRouteArgs {
  ...
  final List<_i23.StoryEntitiy> stories;
...
class StoryViewSlidePageRoute
  ...
  static _i19.PageInfo page = _i19.PageInfo(
    ...
    builder: (data) {
      ...
      return _i17.StoryViewSlidePage(
        key: args.key,
        stories: args.stories,
        username: args.username,
        profilePicture: args.profilePicture,
...
class UserProfileScreenRoute extends _i19.PageRouteInfo<void> {
  ...
  static _i19.PageInfo page = _i19.PageInfo(
    name,
    builder: (data) {
      return const _i18.UserProfileScreen();
    },
  );
}
